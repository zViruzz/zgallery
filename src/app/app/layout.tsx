  ...
  return (
    <main className='min-h-screen w-full bg-primary flex flex-col md:grid md:grid-cols-[16rem_1fr]'>
        ...
        <div className='flex flex-col justify-between w-full h-full sticky'>
          <div>
            <div className='flex justify-center py-5'>
              <Image src={logo} width={135} alt='Logo' />
            </div>
            <ul
          ...
          <div>
            <div className='mb-5'>
              <Link
                href='/plans'
                className='text-base flex bg-secodary rounded-xl px-3 py-2 items-center'
              >
      ...
      <section className='md:py-4 md:pr-4 min-w-full h-screen'>
        <div className='md:bg-secodary rounded-xl w-full h-full'>{children}</div>
      </section>
    </main>
  )
}
